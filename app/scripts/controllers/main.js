...
function modalDemoCtrl($scope, $uibModal, $log) {
    ...
    $scope.open = function () {
        ...
        var modalInstance = $uibModal.open({
            templateUrl: 'views/viewtemplate/modal_example.html',
    ...
    $scope.open1 = function () {
        var modalInstance = $uibModal.open({
            templateUrl: 'views/viewtemplate/modal_example1.html',
            controller: ModalInstanceCtrl
        });
    };
    ...
    $scope.open2 = function () {
        var modalInstance = $uibModal.open({
            templateUrl: 'views/viewtemplate/modal_example2.html',
            controller: ModalInstanceCtrl,
    ...
    $scope.open3 = function (size) {
        var modalInstance = $uibModal.open({
            templateUrl: 'views/viewtemplate/modal_example3.html',
            size: size,
            controller: ModalInstanceCtrl
        });
    };
...
function uploadFileCtrl($scope){
 $scope.doUpload = function(){
       ...
       console.log('title',$scope.title);
        ...
        //$scope.title=$scope.uploadFile.name.length;
